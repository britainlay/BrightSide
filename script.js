...
async function retrieveAddress(suggestion) {
    ...
    try {
        ...
        // New search session after retrieve
        sessionToken =
            createSessionToken();
